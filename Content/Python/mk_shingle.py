...
NEW = {'MI_shingle_grey':  (0.176, 0.184, 0.192),   # weathered slate
       'MI_shingle_brown': (0.196, 0.156, 0.126)}   # asphalt shingle
...
for name, col in NEW.items():
    ...
    MIL.set_material_instance_scalar_parameter_value(mi, 'RoughMin', 0.78)
    MIL.set_material_instance_scalar_parameter_value(mi, 'RoughMax', 0.94)
