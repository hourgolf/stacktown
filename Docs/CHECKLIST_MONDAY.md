# Monday checklist: the C++ camera (owner's test slot, 20 to 30 minutes)
...
| # | Do this | Expected |
|---|---|---|
| 1 | Do nothing for five seconds | The board sits in the frame at the arrival angle, top bar shows money and demand, key legend appears |
...
| 8 | Left-click an empty spot on the plate | A ghost pad follows the cursor, a click places a lot; the camera does NOT move |
| 9 | Left-click a building, then press U | The selection line stays on screen; U requests the upgrade |
...
they belonged to the retired rig. The top bar still comes from the rig's
old HUD and will be replaced by the C++ HUD in step 6.
