...
```
self-tests: 10/10 rules proved they can see their own defect
...
invariants: 10 rules, 5 violated
```

`MAT-01` had never been reported by anything. The lamps have been rendering on
the engine default material since they were built.
