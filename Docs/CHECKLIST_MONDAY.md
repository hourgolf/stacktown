...
2026-09-06 19:41 - rebuild with Tools/package.sh if the date is old; if step 1's pad or the selection outline is missing, the cook dropped a path-loaded asset: grep Saved/StagedBuilds/Mac/Manifest_UFSFiles_Mac.txt for it) is the
