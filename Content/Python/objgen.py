...
Imported as `objgen` by bakegen.py. It existed only in a dead agent scratchpad,
so `from objgen import polys` raised ModuleNotFoundError and bakegen could not
be run at all - the same failure mode as ue.py. This file is objgen_chamfer.py
under the name the rest of the code asks for.
